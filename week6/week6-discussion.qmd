...
System fonts are intalled on all operating machines, so they can be used more or less universally.
...
# these are icons, which are technically part of a font
...
showtext_auto()
showtext_opts(dpi = 300) # ensure consistent DPI
...
#| out-width: "100%"
#.........................create caption.........................
github_icon <- "&#xf09b" # paste font awesome unicode, proceeded by "&#x"
github_username <- "ohemond25"
...
plot <- ggplot(subset_jobs) +
  ...
  geom_linerange(aes(y = occupation,
                     xmin = total_earnings_female, xmax = total_earnings_male)) + 
  geom_point(aes(x = total_earnings_male, y = occupation), 
             color = earnings_pal["males"], # index palette vector to the desired color
             size = 2.5) +
  geom_point(aes(x = total_earnings_female, y = occupation), 
  ...
  theme(
    ...
    # adjust axis text and remove titles
