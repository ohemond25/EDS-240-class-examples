...
# if prompted for selection, input 1 and use ucsb email
...
#| echo: true
ggplot(data = mono, aes(x = year, y = lake_level)) +
  # add rectangle behind line
  annotate(
    geom = "rect",
    xmin = 1941, xmax = 1983,
    ymin = 6350, ymax = 6440,
    fill = "gray90") +
  # add text annotation about water withdrawals
  annotate(
    geom = "text",
    x = 1962, y = 6425,
    label = "unrestricted water diversions\n(1941 - 1983)",
    size = 3) +
  # add information about brine shrimp elevation requirement
  geom_hline(yintercept = 6366,
             linetype = "dashed") +
  # add text annotation about brine shrimp
  annotate(
    geom = "text",
    x = 1900, y = 6366,
