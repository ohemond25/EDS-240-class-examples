...
drought_clean |> 
  ...
  # includes major/minor gridlines and no axis lines
  theme_minimal() +
  
  theme(
    # remove axis and legend titles
    axis.title = element_blank(),
    legend.title = element_blank(),
    
    # move legend to bottom and update size
    legend.position = "bottom",
    legend.key.height = unit(0.25, "cm"),
    legend.key.width = unit(0.4, "cm"),
    
    # add rectangle around outside of plot
    plot.background = element_rect(color = "#686868"),
    
    # update axis lines and tick mark colors
    axis.line = element_line(color = "#5A9CD6"),
    axis.ticks = element_line(color = "#5A9CD6"),
    
    axis.ticks.length = unit(0.2, "cm"),
    
    # move title, change location, change color
    ...
    # update legend and axis font and size
